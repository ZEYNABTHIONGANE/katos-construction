                    ...
                    <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
                        ...
                        <View style={[styles.section, { borderColor: '#2B2E83', borderWidth: 2, backgroundColor: '#F0F4FF' }]}>
                            <View style={styles.sectionHeader}>
                                <MaterialIcons name="straighten" size={24} color="#2B2E83" />
                        ...
                        {/* Niveau Section */}
                        <View style={[styles.section, { borderColor: '#E96C2E', borderWidth: 2, backgroundColor: '#FFF5F0' }]}>
                            <View style={styles.sectionHeader}>
                                <MaterialIcons name="business" size={24} color="#E96C2E" />
                                <Text style={[styles.sectionTitle, { color: '#E96C2E' }]}>Nombre de niveaux</Text>
                            </View>
                        ...
                        {/* Zone Section */}
                        <View style={[styles.section, { borderColor: '#10B981', borderWidth: 2, backgroundColor: '#ECFDF5' }]}>
                            <View style={styles.sectionHeader}>
                                <MaterialIcons name="map" size={24} color="#10B981" />
                                <Text style={[styles.sectionTitle, { color: '#10B981' }]}>Zone de construction (Dakar)</Text>
                            </View>
                        ...
                        <View style={styles.adviceBox}>
                            <MaterialIcons name="info" size={24} color="#E96C2E" />
